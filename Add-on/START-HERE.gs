...
(function (nested) {
  nested.Enums = {
    ...
    //************************************************** SEMANTIC VERSIONING
    CURRENT_ADDON_VERSION:                "0.5.9-testing.5",  //RCM$.ThisAddon.Enums.CURRENT_ADDON_VERSION *** used in Make Test Ready (GO LISTING) AND DEV FLOW **** START HERE TO SET SEM VER
